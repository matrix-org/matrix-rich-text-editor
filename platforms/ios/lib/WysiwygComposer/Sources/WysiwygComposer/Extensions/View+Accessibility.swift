...
public enum WysiwygAccessibilityIdentifier: String {
...
extension View {
    ...
    public func accessibilityIdentifier(_ identifier: WysiwygAccessibilityIdentifier) -> ModifiedContent<Self, AccessibilityAttachmentModifier> {
